import { Post, UserElem } from "../../components";
    ...
    <div className="MainPage">
      ...
      <main className="Main">
        ...
        <div className="Post _liked _marked">
          <UserElem src={"./img/users/aleksandr-maykov.jpeg"} name={"Александр Майков"} text={"Сегодня 9:37"} className={"main__text"} alt={"User"}/>
          <Paragraph classname={"Post__text"} text={"Момент умиротворения и спокойствия"}/>
          <Post/>
